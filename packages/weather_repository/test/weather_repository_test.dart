...
void main() {
  group("WeatherRepository", () {
    ...
    group('constructor', () {
      test('instantiate internal MetaWeatherApiClient when not injected', () {
    ...
    group('getWeather', () {
      ...
      test('return correct weather on success (heavy cloud)', () async {
        final location = MockLocation();
        final weather = MockWeather();
        when(()=> location.woeid).thenReturn(woeid);
        when(()=>location.title).thenReturn('London');
      ...
      test('returns correct on success (light clod)', () async {
        final location = MockLocation();
        final weather = MockWeather();
        when(()=> location.woeid).thenReturn(woeid);
        when(()=> location.title).thenReturn('London');
